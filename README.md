...
> 📖 **宝塔面板用户**：详见 [`docs/BAOTA_DEPLOY.md`](./docs/BAOTA_DEPLOY.md)，本章节是**通用 Linux 服务器**部署的完整指南，覆盖 Docker / 源码 / Nginx / HTTPS / 备份 / 监控 / 升级全流程。
...
如果你用宝塔面板：详见 [`docs/BAOTA_DEPLOY.md`](./docs/BAOTA_DEPLOY.md)，按图操作即可。
